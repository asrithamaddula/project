...
<div class="row">
	<div class="col-md-6 col-md-offset-3">
		<div class="panel panel-primary">
			<div class="panel">
				<h3 style="color:black"><center><strong>SignUp-Personal</strong></center></h3>
			</div>
			...
			<sf:form class="form-horizontal" modelAttribute="user" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<label class="radio-inline"> <sf:radiobutton path="role" value="SUPPLIER" checked="checked"/>Admin
								</label>
							</div>
						</div>
						...
						<button type="submit" class="btn" name="_eventId_billing">
